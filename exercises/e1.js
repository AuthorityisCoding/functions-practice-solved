...
function logMyMessage() {
  console.log('Test logMyMessage: Test 1');
  console.log('Test logMyMessage: Test 2');
}
...
function logMyInfo() {
  console.log('My name is Kris. I am 29 years old!');
  console.log('My name is Emma. I am 23 years old!');
}
